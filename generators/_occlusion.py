...
class OcclusionGenerator(Generator):
    ...
    def __init__(self,
                 ...
                 image_extension = ".jpg",
                 mask_extension = ".png", ### Added by SJChoi on 220714
        ...
        self.mask_extension = mask_extension  ### Added by SJChoi on 220714
    ...
    def prepare_dataset(self, object_path, data_examples, gt_dict, info_dict, class_to_valid_examples):
       ...
       Prepares the Occlusion dataset and converts the data from the Linemod format to the EfficientPose format
        ...
        mask_paths = [mask_path.replace(self.image_extension, self.mask_extension) for mask_path in mask_paths] ### Added by SJChoi on 220714
