...
class AnchorParameters(torch.nn.Module):
    """
    ...
    def __init__(self,
        ...
        self.ratios = torch.tensor(ratios, dtype=floatx)
        self.scales = torch.tensor(ratios, dtype=floatx)
...
AnchorParameters.default = AnchorParameters(
    sizes = [32, 64, 128, 256, 512],
    strides = [8, 16, 32, 64, 128],
    ratios = np.array([1, 0.5, 2], floatx),
